...
export function IcSharpSearch(props: SVGProps<SVGSVGElement>) {
  return (
...
export function IcTwotoneMenuOpen(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
...
export function IcRoundTiktok(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
...
export function OpenmojiYoutube(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 72 72" {...props}>
      ...
      ></path>
      <path fill="#fff" d="M30.05 44.65L45.256 36L30.05 27.35Z"></path>
      <g fill="none" stroke="#000" strokeMiterlimit="10" strokeWidth="2">
        <path d="M63.874 21.906a7.31 7.31 0 0 0-5.144-5.177C54.193 15.505 36 15.505 36 15.505s-18.193 0-22.73 1.224a7.31 7.31 0 0 0-5.144 5.177C6.91 26.472 6.91 36 6.91 36s0 9.528 1.216 14.095a7.31 7.31 0 0 0 5.144 5.177C17.807 56.495 36 56.495 36 56.495s18.193 0 22.73-1.223a7.31 7.31 0 0 0 5.144-5.177C65.09 45.528 65.09 36 65.09 36s0-9.528-1.216-14.094"></path>
        <path
          strokeLinecap="round"
...
// tiktok with color
export function IconParkTiktok(props: SVGProps<SVGSVGElement>) {
  return (
...
// facebook with duo color

export function PhFacebookLogoDuotone(props: SVGProps<SVGSVGElement>) {
  return (
...
export function IcTwotoneLocationOn(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
...
// circle (outlined)
export function IcOutlineCircle(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
...
// circle (filled)
export function IcRoundCircle(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
